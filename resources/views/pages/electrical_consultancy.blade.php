...
@section('content')
    <div class="page-banner" style="background-image: url({{ asset('uploads/'.$g_setting->banner_electrical_consultancy ) }})">
        ...
        <div class="text">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb justify-content-center">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ $ele_cons->name }}</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row service pt_0 pb_0">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div class="photo">
                        <a href="{{ url('electrical-consultancy/'.$row->slug) }}"><img src="{{ asset('uploads/'.$row->photo) }}" alt=""></a>
                    </div>
                    <div class="text">
                        <h3><a href="{{ url('electrical-consultancy/'.$row->slug) }}">{{ $row->name }}</a></h3>
                        <p>
                            {!! nl2br(e($row->short_description)) !!}
                        </p>
                        <div class="read-more d-inline">
                            <a class="d-inline" href="{{ url('electrical-consultancy/'.$row->slug) }}">{{ READ_MORE }}</a>
                        </div>
