...
@section('admin_content')
    <h1 class="h3 mb-3 text-gray-800">Add Architectural Consultancy</h1>

    <form action="{{ route('admin.architectural-consultancy.store') }}" method="post" enctype="multipart/form-data">
        @csrf
