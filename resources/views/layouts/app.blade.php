@php
    $g_setting = DB::table('general_settings')
        ->where('id', 1)
        ->first();
    $s_media = DB::table('social_media_items')
        ->orderBy('social_order', 'asc')
        ->get();
    $footer_col_1 = DB::table('footer_columns')
        ->orderBy('column_item_order', 'asc')
        ->where('column_name', 'Column 1')
        ->get();
    $footer_col_2 = DB::table('footer_columns')
        ->orderBy('column_item_order', 'asc')
        ->where('column_name', 'Column 2')
        ->get();
@endphp
...
<head>
    ...
    @if ($conName[0] == '')
        @php
            $item_row = DB::table('page_home_items')
                ->where('id', 1)
                ->first();
        @endphp
    ...
    @if ($conName[0] == 'about')
        @php
            $item_row = DB::table('page_about_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'services')
        @php
            $item_row = DB::table('page_service_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'service')
        @php
            $item_row = DB::table('services')
                ->where('slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
        <title>{{ $item_row->seo_title }}</title>
    ...
    @if ($conName[0] == 'shop')
        @php
            $item_row = DB::table('page_shop_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'product')
        @php
            $item_row = DB::table('products')
                ->where('product_slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
        <title>{{ $item_row->seo_title }}</title>
    ...
    @if ($conName[0] == 'category')
        @php
            $item_row = DB::table('categories')
                ->where('category_slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
        <title>{{ $item_row->seo_title }}</title>
    ...
    @if ($conName[0] == 'blog' && $conName[1] == '')
        @php
            $item_row = DB::table('page_blog_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'blog' && $conName[1] != '')
        @php
            $item_row = DB::table('blogs')
                ->where('blog_slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
        <title>{{ $item_row->seo_title }}</title>
    ...
    @if ($conName[0] == 'career')
        @php
            $item_row = DB::table('page_career_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'job' && $conName[2] == '')
        @php
            $item_row = DB::table('jobs')
                ->where('job_slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
        <title>{{ $item_row->seo_title }}</title>
    ...
    @if ($conName[0] == 'projects')
        @php
            $item_row = DB::table('page_project_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'project')
        @php
            $item_row = DB::table('projects')
                ->where('project_slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
        <title>{{ $item_row->seo_title }}</title>
    ...
    @if ($conName[0] == 'photo-gallery')
        @php
            $item_row = DB::table('page_photo_gallery_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'video-gallery')
        @php
            $item_row = DB::table('page_video_gallery_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'faq')
        @php
            $item_row = DB::table('page_faq_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'team-members')
        @php
            $item_row = DB::table('page_team_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'team-member')
        @php
            $item_row = DB::table('team_members')
                ->where('slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'contact')
        @php
            $item_row = DB::table('page_contact_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'terms-and-conditions')
        @php
            $item_row = DB::table('page_term_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'privacy-policy')
        @php
            $item_row = DB::table('page_privacy_items')
                ->where('id', 1)
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
    ...
    @if ($conName[0] == 'page')
        @php
            $item_row = DB::table('dynamic_pages')
                ->where('dynamic_page_slug', $conName[1])
                ->first();
        @endphp
        <meta name="description" content="{{ $item_row->seo_meta_description }}">
        <title>{{ $item_row->seo_title }}</title>
    ...
    <style>
        .top,
        {{-- .main-nav nav .navbar-nav .nav-item .dropdown-menu, --}} .video-button:before,
        .video-button:after,
        .special .read-more a,
        .service .read-more a,
        .testimonial-bg,
        ...
        {{-- .main-nav nav .navbar-nav .nav-item a:hover, --}} {{-- .main-nav nav .navbar-nav .nav-item:hover a, --}} .service .service-item .text h3 a:hover,
        ...
        {{-- .main-nav nav .navbar-nav .nav-item .dropdown-menu li a, --}} .contact-item:hover .contact-icon,
        .product-detail .nav-pills .nav-link.active {
            color: #fff !important;
        }
...
<body>
    ...
    @if ($g_setting->preloader_status == 'Show')
        <div id="preloader">
            <div id="status" style="background-image: url({{ asset('uploads/' . $g_setting->preloader_photo) }})">
            </div>
        </div>
    @endif
                            ...
                            <div class="top-social">
                                <ul>
                                    @foreach ($s_media as $row)
                                        <li><a href="{{ $row->social_url }}" target="_blank"><i
                                    ...
                                    @if (!Auth::guard('customer')->user())
                                        ...
                                        @if ($g_setting->top_bar_registration_status == 'Show')
                                            <li class="registration_top_menu">
                                                <a
                                                    href="{{ route('customer.registration') }}">{{ REGISTRATION }}</a>
                                            </li>
                                        @endif
                                    ...
                                    @if ($g_setting->top_bar_cart_status == 'Show')
                                        <li class="cart">
                                            ...
                                            @if (session()->get('cart_product_id'))
                                                <div class="number number_cart">
                                                    {{ count(session()->get('cart_product_id')) }}</div>
                                            @endif
                                        </li>
                                    @endif
    ...
    <div class="footer-area">
        <div class="container">
            ...
            <div class="row footer-end">
                <div class="col-md-6">
                    <div class="copyright">
                        <p>{{ $g_setting->footer_copyright }} Design & Development By
                            <a href="https://www.coderdedhaka.com/" target="_blank">Coder De Dhaka Ltd.</a>
